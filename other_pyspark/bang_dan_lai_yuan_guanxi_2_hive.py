...
/usr/sdp/current/spark2-client/bin/spark-submit \
--master yarn \
--deploy-mode client \
--driver-memory 4g \
--executor-memory 4g \
--executor-cores 2 \
--num-executors 4 \
/data/tmp_lk/person_label/bang_dan_lai_yuan_guanxi_2_hive.py hjc hjcCETC15 JCSJJ
...
insert overwrite table tmp_lk.tag_code_name_map_tmp
select BQFLMC,
       SJBM 
from
(
